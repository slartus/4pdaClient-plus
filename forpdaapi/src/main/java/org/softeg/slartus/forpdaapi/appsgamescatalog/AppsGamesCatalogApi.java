...
public class AppsGamesCatalogApi {
    ...
    private static final String APPS_CATALOG_URL = "http://4pda.ru/forum/index.php?showtopic=" + APPS_PAGE_ID;
    private static final String GAMES_CATALOG_URL = "http://4pda.ru/forum/index.php?showtopic=" + GAMES_PAGE_ID;
    ...
    public static class Games {
        ...
        private static ArrayList<Topic> loadSubCategoryThemes(IHttpClient client, String catalogId, AppGameCatalog subCategory) throws IOException {
            ...
            Pattern themesPattern = Pattern.compile("<li><b><a href=\"http://4pda.ru/forum/index.php\\?showtopic=(\\d+)[^\"]*\" target=\"_blank\">(.*?)</a>(.*?)</li>");
