...
import org.softeg.slartus.forpdaplus.feature_forum.databinding.ForumHeaderNotopicsItemBinding

class ForumHeaderNoTopicsItemFingerprint(
...
class ForumNoTopicsHeaderViewHolder(
    binding: ForumHeaderNotopicsItemBinding,
    private val onClickListener: (view: View?, item: ForumNoTopicsHeaderItem) -> Unit,
    private val onLongClickListener: (view: View?, item: ForumNoTopicsHeaderItem) -> Boolean
) :
