...
public class UberColorPickerDialog extends Dialog {
	...
	private static class ColorPickerView extends View {
		...
		private void drawSwatches(Canvas canvas) {
			...
			canvas.drawText("Отмена", mOldSwatchRect.left + SWATCH_WIDTH / 2 - mText.measureText("Отмена") / 2, mOldSwatchRect.top + 16, mText);
			mText.setColor(Color.WHITE);
			...
			if (mHSV[2] > .5)
				mText.setColor(Color.BLACK);
			canvas.drawText("Выбор", mNewSwatchRect.left + SWATCH_WIDTH / 2 - mText.measureText("Выбор") / 2, mNewSwatchRect.top + 16, mText);
			mText.setColor(Color.WHITE);
