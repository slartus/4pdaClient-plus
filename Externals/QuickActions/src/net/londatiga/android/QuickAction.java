...
public class QuickAction extends PopupWindows {
    ...
    public void show(View anchor, MotionEvent motionEvent) {
        preShow();
        android.view.MotionEvent.PointerCoords pointerCoords = new MotionEvent.PointerCoords();
        motionEvent.getPointerCoords(0, pointerCoords);
        int xPos = (int) pointerCoords.x;
        int yPos = (int) pointerCoords.y + 50;
...
//        }
        ...
        setAnimationStyle(screenWidth, xPos, onTop

        );

        mWindow.showAtLocation(anchor, Gravity.TOP, xPos, yPos);
    ...
    public void show(View anchor) {
        ...
        show(anchor, location, anchor.getTop(), anchor.getHeight(), anchor.getWidth());
    }

    /**
     * Show popup mWindow
     */
    public void show(View anchor, int[] location, int viewTop, int viewHeight, int viewWidth) {
        preShow();

        Rect anchorRect = new Rect(location[0], location[1], location[0] + viewHeight, location[1]
                + viewWidth);
