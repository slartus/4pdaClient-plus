    ...
    private static class ImageUrlAsyncTask
        ...
        protected CacheableBitmapDrawable doInBackground(String... params) {
            try {
                ...
                url = params[0];
                HttpResponse httpResponse = new HttpHelper().getDownloadResponse(url, 0);
                ...
                if (null == result) {
                    ...
                    b = decodeSampledBitmapFromResourceMemOpt(stream, 500, 500);

                    if (b != null) {
//                            if (transform == CIRCLE) {
//                                b = ImgHelper.getCircle(b, context);
//                            } else if (transform == BLUR) {
//                                b = ImgHelper.blur(b);
//                            } else if (transform == THUMBNAIL) {
//                                b = ImgHelper.overlayPlay(b, context);
//                            }
        ...
        protected void onPostExecute(CacheableBitmapDrawable result) {
            ...
            try {
                ...
                if (null != iv && iv.getVisibility() != View.GONE) {
                    ...
                    MaterialImageLoading.animate(iv).setDuration(1000).start();
                }
...
//            startAnimation(fadeInAnimation);
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    ImgHelper.executeOnThreadPool(mCurrentTask, url);
                } else {
